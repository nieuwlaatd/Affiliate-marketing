...
| 0.3 | ✅ **Author identity on content** (done 2026-06-27): byline on blog posts linking to `/about`; Article schema author updated. NOTE 👤: replacing the "Editorial Team" byline with a real named editor + bio/photo in `lib/editorial.ts` is a further E-E-A-T upgrade only Dylan can authorize. | 🤖 / 👤 | Turns anonymous content into E-E-A-T-credible content. |
